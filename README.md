...
[![Version](https://img.shields.io/badge/latest_release-v0.1.5-orange.svg)](https://github.com/edadma/yaml/releases/tag/v0.1.5)
...
libraryDependencies += "xyz.hyperreal" %% "yaml" % "0.1.5"
```
